(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('core-js/modules/es.array.concat.js'), require('core-js/modules/es.array.iterator.js'), require('core-js/modules/es.array-buffer.constructor.js'), require('core-js/modules/es.array-buffer.slice.js'), require('core-js/modules/es.data-view.js'), require('core-js/modules/es.object.to-string.js'), require('core-js/modules/es.typed-array.uint8-array.js'), require('core-js/modules/es.typed-array.copy-within.js'), require('core-js/modules/es.typed-array.every.js'), require('core-js/modules/es.typed-array.fill.js'), require('core-js/modules/es.typed-array.filter.js'), require('core-js/modules/es.typed-array.find.js'), require('core-js/modules/es.typed-array.find-index.js'), require('core-js/modules/es.typed-array.for-each.js'), require('core-js/modules/es.typed-array.includes.js'), require('core-js/modules/es.typed-array.index-of.js'), require('core-js/modules/es.typed-array.iterator.js'), require('core-js/modules/es.typed-array.join.js'), require('core-js/modules/es.typed-array.last-index-of.js'), require('core-js/modules/es.typed-array.map.js'), require('core-js/modules/es.typed-array.reduce.js'), require('core-js/modules/es.typed-array.reduce-right.js'), require('core-js/modules/es.typed-array.reverse.js'), require('core-js/modules/es.typed-array.set.js'), require('core-js/modules/es.typed-array.slice.js'), require('core-js/modules/es.typed-array.some.js'), require('core-js/modules/es.typed-array.sort.js'), require('core-js/modules/es.typed-array.subarray.js'), require('core-js/modules/es.typed-array.to-locale-string.js'), require('core-js/modules/es.typed-array.to-string.js'), require('core-js/modules/es.array.slice.js'), require('core-js/modules/es.regexp.to-string.js'), require('core-js/modules/es.array.index-of.js'), require('core-js/modules/es.map.js'), require('core-js/modules/es.regexp.exec.js'), require('core-js/modules/es.set.js'), require('core-js/modules/es.string.iterator.js'), require('core-js/modules/es.string.search.js'), require('core-js/modules/web.dom-collections.iterator.js'), require('core-js/modules/es.number.constructor.js'), require('core-js/modules/es.number.parse-int.js'), require('core-js/modules/es.array.map.js'), require('core-js/modules/es.typed-array.uint16-array.js'), require('core-js/modules/es.string.from-code-point.js'), require('core-js/modules/es.array.for-each.js'), require('core-js/modules/es.function.name.js'), require('core-js/modules/es.object.keys.js'), require('core-js/modules/web.dom-collections.for-each.js'), require('core-js/modules/es.array.join.js'), require('core-js/modules/es.string.replace.js'), require('core-js/modules/es.string.code-point-at.js'), require('domhandler'), require('@/core/enums/richText'), require('@/utils'), require('core-js/modules/es.array.find.js'), require('core-js/modules/es.array.some.js'), require('core-js/modules/es.array.last-index-of.js'), require('core-js/modules/es.array.splice.js'), require('@/core/enums/question'), require('@/core/enums/rule'), require('@/core/watcher')) :
    typeof define === 'function' && define.amd ? define(['exports', 'core-js/modules/es.array.concat.js', 'core-js/modules/es.array.iterator.js', 'core-js/modules/es.array-buffer.constructor.js', 'core-js/modules/es.array-buffer.slice.js', 'core-js/modules/es.data-view.js', 'core-js/modules/es.object.to-string.js', 'core-js/modules/es.typed-array.uint8-array.js', 'core-js/modules/es.typed-array.copy-within.js', 'core-js/modules/es.typed-array.every.js', 'core-js/modules/es.typed-array.fill.js', 'core-js/modules/es.typed-array.filter.js', 'core-js/modules/es.typed-array.find.js', 'core-js/modules/es.typed-array.find-index.js', 'core-js/modules/es.typed-array.for-each.js', 'core-js/modules/es.typed-array.includes.js', 'core-js/modules/es.typed-array.index-of.js', 'core-js/modules/es.typed-array.iterator.js', 'core-js/modules/es.typed-array.join.js', 'core-js/modules/es.typed-array.last-index-of.js', 'core-js/modules/es.typed-array.map.js', 'core-js/modules/es.typed-array.reduce.js', 'core-js/modules/es.typed-array.reduce-right.js', 'core-js/modules/es.typed-array.reverse.js', 'core-js/modules/es.typed-array.set.js', 'core-js/modules/es.typed-array.slice.js', 'core-js/modules/es.typed-array.some.js', 'core-js/modules/es.typed-array.sort.js', 'core-js/modules/es.typed-array.subarray.js', 'core-js/modules/es.typed-array.to-locale-string.js', 'core-js/modules/es.typed-array.to-string.js', 'core-js/modules/es.array.slice.js', 'core-js/modules/es.regexp.to-string.js', 'core-js/modules/es.array.index-of.js', 'core-js/modules/es.map.js', 'core-js/modules/es.regexp.exec.js', 'core-js/modules/es.set.js', 'core-js/modules/es.string.iterator.js', 'core-js/modules/es.string.search.js', 'core-js/modules/web.dom-collections.iterator.js', 'core-js/modules/es.number.constructor.js', 'core-js/modules/es.number.parse-int.js', 'core-js/modules/es.array.map.js', 'core-js/modules/es.typed-array.uint16-array.js', 'core-js/modules/es.string.from-code-point.js', 'core-js/modules/es.array.for-each.js', 'core-js/modules/es.function.name.js', 'core-js/modules/es.object.keys.js', 'core-js/modules/web.dom-collections.for-each.js', 'core-js/modules/es.array.join.js', 'core-js/modules/es.string.replace.js', 'core-js/modules/es.string.code-point-at.js', 'domhandler', '@/core/enums/richText', '@/utils', 'core-js/modules/es.array.find.js', 'core-js/modules/es.array.some.js', 'core-js/modules/es.array.last-index-of.js', 'core-js/modules/es.array.splice.js', '@/core/enums/question', '@/core/enums/rule', '@/core/watcher'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.question = {}, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, global.domhandler, global.richText, global.utils, null, null, null, null, global.question, global.rule, global.watcher));
})(this, (function (exports, es_array_concat_js, es_array_iterator_js, es_arrayBuffer_constructor_js, es_arrayBuffer_slice_js, es_dataView_js, es_object_toString_js, es_typedArray_uint8Array_js, es_typedArray_copyWithin_js, es_typedArray_every_js, es_typedArray_fill_js, es_typedArray_filter_js, es_typedArray_find_js, es_typedArray_findIndex_js, es_typedArray_forEach_js, es_typedArray_includes_js, es_typedArray_indexOf_js, es_typedArray_iterator_js, es_typedArray_join_js, es_typedArray_lastIndexOf_js, es_typedArray_map_js, es_typedArray_reduce_js, es_typedArray_reduceRight_js, es_typedArray_reverse_js, es_typedArray_set_js, es_typedArray_slice_js, es_typedArray_some_js, es_typedArray_sort_js, es_typedArray_subarray_js, es_typedArray_toLocaleString_js, es_typedArray_toString_js, es_array_slice_js, es_regexp_toString_js, es_array_indexOf_js, es_map_js, es_regexp_exec_js, es_set_js, es_string_iterator_js, es_string_search_js, web_domCollections_iterator_js, es_number_constructor_js, es_number_parseInt_js, es_array_map_js, es_typedArray_uint16Array_js, es_string_fromCodePoint_js, es_array_forEach_js, es_function_name_js, es_object_keys_js, web_domCollections_forEach_js, es_array_join_js, es_string_replace_js, es_string_codePointAt_js, domhandler, richText, utils, es_array_find_js, es_array_some_js, es_array_lastIndexOf_js, es_array_splice_js, question, rule, watcher) { 'use strict';
    ...
    class InputSettings {
        ...
        selectValueStr;
        constructor(options) {
            this.type = options?.type ?? richText.InputTypeEnum.TEXT;
            this.style = options?.style ?? richText.InputBorderStyleEnum.UNDERLINE;
    ...
    class Input {
        ...
        constructor(input) {
            ...
            this.el = this.parse();
            this.id = this?.el?.attribs?.inputid ?? utils.uuid();
        }
        render() {
            if (!this.el)
                return '';
        ...
        parseTextInput(el) {
            ...
            const options = {
                type: 'text',
                class: attribs.class || '',
                inputid: attribs.inputid ?? utils.uuid(),
                autocomplete: 'new-password',
                data: attribs.data || '',
                maxlength: settings.maxCharacter.toString(),
                style: `width: ${settings.width}px`
            };
            if (settings.type == richText.InputTypeEnum.SELECT) {
                options.type = 'button';
            }
            if (settings.style == richText.InputBorderStyleEnum.ALLBORDER) {
                options.class += ' allBorder';
            }
            else {
                options.class += ' underline';
            }
            const input = new domhandler.Element('input', options);
            return input;
        }
    ...
    class Rule {
         ...
         */
        optionLogic = rule.OptionLogicEnum.OR;
        /**
         * 规则所在的选项id
         */
        optionId;
    ...
    class Answer extends watcher.Duplex {
        questionId;
    ...
    class Radio extends Question {
        type = question.QuestionTypeEnum.Radio;
        showColNum;
        optionList;
        isShowOtherOption;
        otherOptionData;
    ...
    class Table extends Question {
        type = question.QuestionTypeEnum.Table;
        colWidth;
        groupList;
        isShowTitle;
        maximumCheck;
    ...
    class QuestionVisiableRuleItem extends Map {
        ...
        isTrigger() {
            ...
            // 为and时，必须所有的都触发才可以
            if (isSameRule && this.optionLogic === rule.OptionLogicEnum.AND) {
    ...
    const ClazzMap = {
        [question.QuestionTypeEnum.Radio]: Radio,
        [question.QuestionTypeEnum.Check]: Check,
        [question.QuestionTypeEnum.Table]: Table,
    ...
    exports.TableGroupOption = TableGroupOption;
